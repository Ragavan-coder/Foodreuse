  ...
  return (
    <footer className="bg-white border-t border-gray-100">
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-2 gap-8 md:w-1/2">
          <div>
            <h3 className="text-sm font-semibold leading-6 text-gray-900">Navigation</h3>
            <ul className="mt-3 space-y-2">
              <li>
                <Link to="/" className="text-sm leading-6 text-gray-600 hover:text-green-500">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/donations" className="text-sm leading-6 text-gray-600 hover:text-green-500">
                  Donations
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-sm leading-6 text-gray-600 hover:text-green-500">
                  About Us
                </Link>
              </li>
            </ul>
